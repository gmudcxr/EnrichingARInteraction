...
public class ColliderManager : MonoBehaviour {    
    ...
    [Header("Label Settings")] public float characterSize = 10.0f;
    ...
    private void OnGUI() {
        ...
        // }
        // disable
        // if(GUI.Button(new Rect(10, 10, 170, 20), "Toggle Centerpoints")) {  //Button that triggers grid seed generation   
        ...
        // }
        // if(GUI.Button(new Rect(190, 10, 170, 20), "Toggle Boundaries")) { //Button that triggers grid seed generation    
